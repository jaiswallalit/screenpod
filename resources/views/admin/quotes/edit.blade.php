         ...
         <div class="row mb-2">
            ...
            <div class="col-sm-6">
               <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active">SalesQuote Details</li>
               </ol>
            </div>
         </div>
      </div>
...
<div class="modal fade" id="modal-default1_{{$key}}">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{route('quotes.addTrd')}}" method="post">
                {{csrf_field()}}
                <input type="hidden" name="quote_id" value="{{$result->id}}">
                <input type="hidden" name="product_id" value="{{$product['id']}}">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="price" class="form-control" id="price" placeholder="price" value="<?php if (!empty($extra_info)) {echo $extra_info->price; } ?>">
                    </div>
                    <div class="form-group">
                        <label for="image">image</label>
                        <input type="file" name="image" class="form-control" id="image" placeholder="Image" value="<?php if (!empty($extra_info)) { echo $extra_info->image; } ?>>
                                             </div>
                                          </div>
                                          <div class=" modal-footer justify-content-between">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
