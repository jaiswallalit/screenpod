                  ...
                  <form id="quickForm" action="{{route('leads.update')}}" method="POST" enctype="multipart/form-data">
                     ...
                     <div class="row">
                        ...
                        <div class="form-group">
                           ...
                           <input type="text" name="title" id="title" class="form-control" placeholder="Enter Lead Company" value="{{$result->title}}">
                        </div>
                        </div>
                        <div class="col-md-6">
                        <div class="form-group">
                           <label for="Source">Lead Source</label>
                           <input type="text" name="lead_source" id="Source" class="form-control" placeholder="Enter Lead Source" value="{{$result->lead_source}}">
                        </div>
                        </div></div>
                        <div class="form-group">
