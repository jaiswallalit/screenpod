                        ...
                        <tbody class="tablecontents" id="tablecontents">
                           ...
                           <tr class="row1" id="row1" data-id="{{ $result->id }}">
                              ...
                              <!--<td>{{$result->name}} {{Auth::user()->user_type}}</td>-->
                                 <td>{{$result->name}} </td>
                              <td>
                                 <ul class="list-inline"><li class="list-inline-item"><img alt="Avatar" class="table-avatar" src="{{url('/public/admin/clip-one/assets/dealers/thumbnail')}}/{{$result->image}}"></li></ul>
