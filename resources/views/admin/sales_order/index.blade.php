            ...
            <div class="col-lg-12">
               <div class="card">
                 ...
                 ?>
                  ...
                  <a href="{{route('sales_order.add', '23_' . $order_number )}}" class="btn btn-info float-right"><i class="fas fa-plus"></i> Create Sales Order</a>
                  </div>
               @endif
                  <div class="card-body">
                        ...
                        <table id="tableID" class="table table-bordered" >
                           <thead>
                              <tr style="background-color: #ccc;">
                                 ...
                                 <th style="width: 50px;text-align: center;">Order Status</th>
                           ...
                           <tbody class="tablecontents" id="tablecontents">
                             ...
                             // if (!empty($rep)) {
                              ...
                              @endif
                                 ...
                                 <td>
                                 @if(!empty($result->machine_order_number))

                                 <a href="{{route('sales_order.specheet', $result->machine_order_number)}}" class="" data-placement="top" data-original-title="View" style="width: 83px;">View </a>
                                 @endif
                              </td>
                                 ...
                                 @if($result->delivered == '1')
                                  ...
                                  <td>@if (!empty($checkPermission) || Auth::user()->user_type == 'admin')
                                       <a href=""  class="btn btn-success" data-target="#order_completed" data-toggle="modal">Order Completed</a>
                                       @endif</td>
                                       <td>@if (!empty($checkPermission) || Auth::user()->user_type == 'admin')
