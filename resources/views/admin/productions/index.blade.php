...
<div class="content-wrapper">
   <div class="content-header">
      <div class="container-fluid">
         <div class="row mb-2">
            <div class="col-sm-6">
               <h1 class="m-0 text-dark">Production Planning</h1>
            </div>
            <div class="col-sm-6">
               <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item"><a href="#">Home</a></li>
                  <li class="breadcrumb-item active">Production Planning List</li>
               </ol>
            </div>
         </div>
      </div>
                        ...
                        <table id="tableID" class="table table-bordered" >
                           <thead>
                              <tr style="background-color: #ccc;">
                               ...
                               <th>Serial</th>
                              <th>Build Shed</th>
                              <th>Purchasing Sheet Issued</th>
                              <th>Steel Parts Due</th>
                              <th>Parts Due</th>
                              <th>Start</th>
                              <th>Electrics Star</th>
                              <th style="width: 50px;text-align: center;">PDI</th>
                              <th style="width: 50px;text-align: center;">Ready For Dispatch</th>
                              <th style="width: 50px;text-align: center;">Dispatched</th>
                           ...
                           <tbody class="tablecontents" id="tablecontents">
                             ...
                             // if (!empty($rep)) {
                              ...
                              {{$result->order_number}}
                                 ...
                                 <td> {{$result->machine_order_number}}
                                 </td>
                                 <td> {{$result->make}}
                                 </td>
                                 <td>
                                 ...
                                 <td>{{$result->build_shed}}</td>
                                
                                 @if($result->purchased_sheet == '1')
                                    <td  style="background: #28a745;"></td>
                                    @else
                                    <td style="background: #dc3545;"></td>
                                 @endif
                                 @if($result->steel_parts_due == '1')
                                    <td  style="background: #28a745;"></td>
                                    @else
                                    <td style="background: #dc3545;"></td>
                                 @endif
                                 @if($result->parts_due == '1')
                                    <td  style="background: #28a745;"></td>
                                    @else
                                    <td style="background: #dc3545;"></td>
                                 @endif
                                 <td>{{$result->build_start_week}}</td>

                                 <td>{{$result->electrics_start_week}}</td>
                                 ...
                                 @if($result->ready_for_dispatch == '1')
                                    <td  style="background: #28a745;"></td>
                                    @else
                                    <td style="background: #dc3545;"></td>
                                    @endif
                                    @if($result->machine_dispatched == '1')
                                    <td  style="background: #28a745;"></td>
                                    @else
                                    <td style="background: #dc3545;"></td>
                                    @endif
                                       <td>@if (!empty($checkPermission) || Auth::user()->user_type == 'admin')
                                       <a href="{{route('production.view', $result->id)}}" class="btn btn-info btn-sm" data-placement="top" data-original-title="View" style="width: 83px;"><i class="fas fa-eye"></i>View</a>
