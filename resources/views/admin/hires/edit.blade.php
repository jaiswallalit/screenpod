...
<div class="content-wrapper">
   <div class="content-header">
      <div class="container-fluid">
         <div class="row mb-2">
            <div class="col-sm-6">
               <h1 class="m-0 text-dark">Hire</h1>
            </div>
            <div class="col-sm-6">
               <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Home</a></li>
                  <li class="breadcrumb-item active">Hire Edit</li>
               </ol>
            </div>
         </div>
      </div>
            ...
            <div class="col-md-12">
               <div class="card card-primary">
                  <div class="card-header">
                     <h3 class="card-title">Edit <small>Hire</small></h3>
                  </div>
                  @if (count($errors) > 0)       
                  ...
                  @endif
                  <form id="quickForm" action="{{route('hires.update')}}" method="POST" enctype="multipart/form-data" >
                     {{csrf_field()}}
                     ...
                     <div class="card-body">
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 <label for="backorder_number">Whole Number</label>
                              ...
                              <div class="form-group">
                                 ...
                                 <select name="type" class="type form-control" id="type" data-placeholder="Select a type" style="width: 100%;" required>
                                    ...
                                    <option value="Used" <?php if($result->type == 'Used'){echo "selected";} ?>>Used</option>
                                     <option value="Trade" <?php if($result->type == 'Trade'){echo "selected";} ?>>Trade</option>
                                 </select>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 <label for="image">Hire Images</label>
                                 <input type="file" name="image[]" class="form-control" id="image" accept="image/*" multiple>
                              </div>
                              @if (count($HireImages)>0)
                                <br>
                                @foreach($HireImages as $productImage)
                                 <div class="custom_close">
                                    <img src="{{ asset('/admin/clip-one/assets/hiress/thumbnail')}}/{{ $productImage->image }}" alt="" class="product-edit-img"> 
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <?php if (!empty($result->attachment)){ ?>
                                    ...
                                    <a class="" href="{{ asset('/admin/clip-one/assets/hires/attachment')}}/{{ $result->attachment }}" target="_blank" downlaod="{{ $result->attachment }}"><span>{{$result->attachment}}</span></a>
                                 <?php } ?> 
                              </div>
                           </div>
                        </div>
                     ...
                     <div class="card-footer">
                        <div>
                           ...
                           <a href="{{route('hires.index')}}" class="btn btn-default btn-secondary">Back</a>
                        </div>
                     </div>
                  </form>
               </div>
...
<script>
   $(document).ready(function(){
     $('.product-edit-btn').on('click',function(){
         ...
         $.ajax({
             url: "{{ url('admin/hires/image/delete') }}/"+id,
             method: "get",
