...
<div class="content-wrapper">
   <div class="content-header">
      <div class="container-fluid">
         <div class="row mb-2">
            <div class="col-sm-6">
               <h1 class="m-0 text-dark">Hire Quotes</h1>
            </div>
            <div class="col-sm-6">
               <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item"><a href="#">Home</a></li>
                  <li class="breadcrumb-item active">Hire Quotes List</li>
               </ol>
            </div>
         </div>
      </div>
         ...
         <div class="row">
            <div class="col-lg-12">
               ...
               <div class="card-header float-right">
                  <a href="{{route('hirequotes.add')}}" class="btn btn-custom float-right"><i class="fas fa-plus"></i> Create Hire Quote</a>
                  </div>
