...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1> Create Hire Order</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
                        <li class="breadcrumb-item active">Create Hire Order</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Add <small>Hire Order</small></h3>
 ...
 <!-- Modal -->
     <div class="modal fade" id="add_machine">
         ...
         <!-- Modal -->
                        ...
                        @endif
                        <form id="quickForm" action="{{route('hire_order.save')}}" method="POST" enctype="multipart/form-data">
                            {{csrf_field()}}
                            <div class="card-body">
                            <div class="row">
                                    <div class="col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="extras" class="form-control" id="extras" placeholder="Extras">
                             ...
                             <h4 class="mainhead">Hire Details</h4>
                                    ...
                                    <div class="col-md-2">
                                    <div class="form-group">
                                    <label for="date_duration">Date From - To</label>
                                    <input type="date" name="date_duration" class="form-control" id="date_duration">
                                     </div>
                                    </div>

                                    <div class="col-md-2">
                                    <div class="form-group">
                                    <label for="date_duration">Duration (weeks)</label>
                                    <input type="text" name="duration" class="form-control" id="duration" placeholder="Duration (weeks)">
                                     </div>
                                    </div>

                                    <div class="col-md-2">
                                    <div class="form-group">
                                    <label for="price">Weekly Price</label>
                                    ...
                                    <select name="currency" class="currency select12 form-control" id="currency" data-placeholder="Select a currency" style="width: 100%;" required="">
                                    ...
                                    <input type="text" name="transport" class="form-control" id="transport" placeholder="transport">
                                     </div>
                                    </div>
                                    <div class="col-md-2">
                                    <div class="form-group">
                                    <label for="transport_price">transport_price</label>
                                    <input type="text" name="transport_price" class="form-control" id="transport_price" placeholder="transport price">
                                     </div>
                                    </div>
                                    <div class="col-md-2">
                                    <div class="form-group">
                                    <label for="depot">depot</label>
                                    <input type="text" name="depot" class="form-control" id="depot" placeholder="depot">
                                     </div>
                                    </div>
                                    <div class="col-md-12">
                                    <div class="form-group">
                                    ...
                                    <div class="card-footer">
                                        <div>
                                            ...
                                            <a href="{{route('hire_order.index')}}" class="btn btn-default btn-secondary float-right">Back</a>
                                        </div>
                                    </div>
                        </form>
                    </div>
