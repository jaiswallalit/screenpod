...
use App\Http\Controllers\Front\HireController as HireC;
...
use App\Http\Controllers\Admin\SiteVisitsController;
...
use App\Http\Controllers\Admin\HireOrderController;
...
//     echo '<h1>session table lalit<h1>';
// });
...
Route::group(['prefix'=> 'admin','middleware' => ['auth','UserRole']] , function(){
    ...
    /// Sub Admin start ////
    // Route::get('sub_admin/index', ['as'=>'sub_admin.indexho',  'uses'=>'Admin\SubAdminController@index']);
...
/// report ////
    Route::get('reports/quotes', [QuoteController::class, 'quotereport'])->name('quotes_report.quotereport');
    Route::get('reports/complete_sales', [SalesOrderReportController::class, 'completesales'])->name('reports.complete_sales');

    /// products ////
    // Route::get('products/index', ['as'=>'products.index',  'uses'=>'Admin\ProductController@index']);
    Route::get('products/index', [ProductController::class, 'index'])->name('products.index');
        Route::get('products/instock', [ProductController::class, 'instock'])->name('instock.instock');

        Route::get('products/tradein', [ProductController::class, 'usedEquipments'])->name('products.tradein');
    ...
    Route::get('products/getMakes/{id}', [ProductController::class, 'getMakes'])->name('products.getMakes');
    Route::get('products/geteditMakes/{id}', [ProductController::class, 'geteditMakes'])->name('products.geteditMakes');

    Route::POST('products/servicehistory', [ProductController::class, 'service_history'])->name('products.servicehistory');

    Route::get('products/view/{id}', [ProductController::class, 'view'])->name('products.view');


    /// Hires ////
        Route::get('hires/index', [HireController::class, 'index'])->name('hires.index');

        Route::get('hires/instock', [HireController::class, 'instock'])->name('hires.instock');

        Route::get('hires/tradein', [HireController::class, 'usedEquipments'])->name('hires.tradein');

        Route::get('hires/add', [HireController::class, 'add'])->name('hires.add');

        Route::POST('hires/save', [HireController::class, 'save'])->name('hires.save');

        Route::get('hires/edit/{id}', [HireController::class, 'edit'])->name('hires.edit');
    
        Route::POST('hires/update', [HireController::class, 'update'])->name('hires.update');

        Route::get('hires/delete/{id}', [HireController::class, 'delete'])->name('hires.delete');

        Route::get('hires/status/{id}', [HireController::class, 'status'])->name('hires.status');

        Route::get('hires/image/delete/{id}', [HireController::class, 'imageDelete'])->name('hires.image.delete');

        Route::POST('hires/sortProducts', [HireController::class, 'sortProducts'])->name('hires.sortProducts');

        Route::POST('hires/add_more', [HireController::class, 'add_more'])->name('hires.add_more');

  /// Hires End////

 
  
  Route::get('sub/submit', [SubmitLinks::class, 'index'])->name('sub.submit');

  Route::get('sub/submit2', [SubmitLinks::class, 'submitUrl'])->name('sub.submit2');

  Route::get('sub/submit3', [SubmitLinks::class, 'submitData'])->name('sub.submit3');
    ...
    // Route::POST('customers/save', ['as'=>'customers.save',  'uses'=>'Admin\CustomerController@save']);
     ...
     Route::POST('customers/csave', [CustomerController::class, 'savecustomeronlead'])->name('customers.csave');
    ...
    Route::any('customers/import', [CustomerController::class, 'import'])->name('customers.import');
       ...
       /// SIte Visits ////
    Route::get('site_visits/index', [SiteVisitsController::class, 'index'])->name('site_visits.index');
    Route::get('site_visits/add', [SiteVisitsController::class, 'add'])->name('site_visits.add');
    Route::POST('site_visits/save', [SiteVisitsController::class, 'save'])->name('site_visits.save');
    Route::get('site_visits/edit/{id}', [SiteVisitsController::class, 'edit'])->name('site_visits.edit');
    Route::POST('site_visits/update', [SiteVisitsController::class, 'update'])->name('site_visits.update');

    Route::get('site_visits/view/{id}', [SiteVisitsController::class, 'view'])->name('site_visits.view');
    Route::get('site_visits/delete/{id}', [SiteVisitsController::class, 'delete'])->name('site_visits.delete');
    Route::POST('site_visits/comment', [SiteVisitsController::class, 'comment'])->name('site_visits.comment');
    ...
    /// Hire Quotes ////
    Route::get('hirequotes/add/', [QuoteController::class, 'createHireQuote'])->name('hirequotes.add');
    Route::POST('hirequotes/save', [QuoteController::class, 'hiresave'])->name('hirequotes.save');
    Route::get('hirequotes/index', [QuoteController::class, 'hirequote'])->name('hirequotes.index');
    Route::get('hirequotes/delete/{id}', [QuoteController::class, 'hiredelete'])->name('hirequotes.delete');
    Route::get('hirequotes/view/{id}', [QuoteController::class, 'hireview'])->name('hirequotes.view');
    Route::get('hirequotes/edit/{id}', [QuoteController::class, 'hireedit'])->name('hirequotes.edit');
    Route::POST('hirequotes/update', [QuoteController::class, 'hireupdate'])->name('hirequotes.update');
    Route::POST('hirequotes/addMachine', [QuoteController::class, 'hireaddMachine'])->name('hirequotes.addMachine');
    Route::get('hirequotes/hiregetProducts/{id}/{type}/{dealer_id}', [QuoteController::class, 'hiregetProducts'])->name('hirequotes.hiregetProducts');
    
    ///16may//
    Route::POST('hirequotes/hire_info', [QuoteController::class, 'hireInfo'])->name('hirequotes.hire_info');
    Route::get('hirequotes/sendhireorder/{id?}', [QuoteController::class, 'sendhireorder'])->name('hirequotes.sendhireorder');
    Route::get('hire_order/index', [HireOrderController::class, 'index'])->name('hire_order.index');
    Route::get('hire_order/contract/{id}', [HireOrderController::class, 'Contract'])->name('hire_order.contract');
    Route::get('hire_order/view/{id}', [HireOrderController::class, 'view'])->name('hire_order.view');
    Route::POST('hire_order/update', [HireOrderController::class, 'update'])->name('hire_order.update');
    Route::get('hire_order/add/', [HireOrderController::class, 'createSalesOrder'])->name('hire_order.add');
    Route::POST('hire_order/save', [HireOrderController::class, 'save'])->name('hire_order.save');
    Route::POST('hire_order/updateinfo', [HireOrderController::class, 'UpdateContract'])->name('hire_order.updateinfo');
    Route::POST('hire_order/statement', [HireOrderController::class, 'Statement'])->name('hire_order.statement');
...
///17 Production Management  ////
        ...
        Route::get('production/sendproduction/{id?}', [ProductionController::class, 'createProduction'])->name('production.sendproduction');
        ...
        Route::POST('production/save', [ProductionController::class, 'save'])->name('production.save');
        Route::get('production/view/{id}', [ProductionController::class, 'view'])->name('production.view');
        Route::POST('production/update', [ProductionController::class, 'update'])->name('production.update');
       
        Route::get('productions/add', [ProductionController::class, 'add'])->name('productions.add');
...
Route::get('/sign/{id}', [HireOrderController::class, 'sign'])->name('sign');
Route::post('/add/signature', [HireOrderController::class, 'store']);

Route::post('/signature', [HireOrderController::class, 'store'])->name('signature.store');
    ...
    Route::get('quotes/index', [QuoteController::class, 'index'])->name('quotes.index');
     Route::get('quotes/pdffile/{id}', [QuoteController::class, 'showPDF'])->name('quotes.pdffile');
    Route::get('quotes/delete/{id}', [QuoteController::class, 'delete'])->name('quotes.delete');
    ...
    Route::get('quotes/addtrade/{id?}', [QuoteController::class, 'addtrade'])->name('quotes.addtrade');
    Route::POST('quotes/addtrade', [QuoteController::class, 'savetrade'])->name('quotes.savetrade');
    ...
    Route::POST('quotes/addTrd', [QuoteController::class, 'addTrd'])->name('quotes.addTrd');
    Route::POST('sales_order/addExtra', [SalesOrderController::class, 'addExtra'])->name('sales_order.addExtra');
     Route::POST('sales_order/addTrd', [SalesOrderController::class, 'addTrd'])->name('sales_order.addTrd');
    Route::get('quotes/add/', [QuoteController::class, 'createQuote'])->name('quotes.add');
    Route::POST('quotes/save', [QuoteController::class, 'save'])->name('quotes.save');
    ...
    Route::get('quotes/sendorder/{id?}', [QuoteController::class, 'sendorder'])->name('quotes.sendorder');


    
    /// sales_order ////
           /// New 4may sales_order ////
           Route::get('sales_order/machineview/{id}', [SalesOrderController::class, 'machineview'])->name('sales_order.machineview');
           Route::get('sales_order/machineedit/{machine_order_number}', [SalesOrderController::class, 'machineedit'])->name('sales_order.machineedit');
           Route::POST('sales_order/machinespecsheet', [SalesOrderController::class, 'machinespecsheet'])->name('sales_order.machinespecsheet');
         
           Route::get('sales_order/specheet/{id}', [SalesOrderController::class, 'specview'])->name('sales_order.specheet');

           Route::get('sales_order/getProductMakes/{id}', [SalesOrderController::class, 'getProductMakes'])->name('sales_order.getProductMakes');
           Route::POST('sales_order/ordercompleted', [SalesOrderController::class, 'orderCompleted'])->name('sales_order.ordercompleted');
...
//    Route::get('sales_order/edit/{id}', ['as'=>'sales_order.edit', 'uses'=>'Admin\SalesOrderController@edit']);
  ...
  Route::get('sales_order/add/{id}', [SalesOrderController::class, 'createSalesOrder'])->name('sales_order.add');

     Route::POST('sales_order/save', [SalesOrderController::class, 'save'])->name('sales_order.save');
     Route::POST('sales_order/machinesave', [SalesOrderController::class, 'machinesave'])->name('sales_order.machinesave');
 ...
 Route::get('sales_order/delete/{id}', [SalesOrderController::class, 'delete'])->name('sales_order.delete');
    /// Trade In ////
...
Route::get('trade_in/view/{id}', [TradeInController::class, 'view'])->name('trade_in.view');
    ...
    Route::get('trade_in/delete/{id}', [TradeInController::class, 'delete'])->name('trade_in.delete');
    Route::get('trade_in/edit/{id}', [TradeInController::class, 'edit'])->name('trade_in.edit');

    Route::POST('trade_in/update', [TradeInController::class, 'update'])->name('trade_in.update');
